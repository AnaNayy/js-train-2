//Задача 1: Напишіть функцію, яка буде виконувати js код який передали в
// функцію через аргумент в форматі тексту
...
// Задача 2: Напишіть функцію, яка приймає рядок та повертає число з цього рядка або
// повідомлення про помилку.

// Створюємо функцію з назвою getNumberFromString, яка приймає один аргумент s
function getNumberFromString(s) {
  // Використовуємо функцію parseFloat для того, щоб спробувати отримати число
  // з рядка
...
// Задача 3: Напишіть функцію, яка приймає рядок та повертає ціле число з цього
// рядка або повідомлення про помилку.

// Створюємо функцію з назвою getIntegerFromString, яка приймає один аргумент s
function getIntegerFromString(s) {
  // Використовуємо функцію parseInt для того, щоб спробувати отримати ціле число
  // з рядка
  // Перевіряємо, чи є отримане значення числом за допомогою isNaN
  // Якщо значення не є числом, повертаємо текст "Couldn't extract an integer from the provided string."
  // Якщо значення є числом, повертаємо його
  let number3 = parseInt(s);
...
function isNumberFinite(num) {
  // Використовуємо вбудовану функцію isFinite, щоб перевірити, чи є введене число
  // скінченним.
  // Ця функція повертає true, якщо число є скінченним, і false, якщо число є
  // нескінченним або не є числом.
...
function createURLObject(urlStr) {
  // Використовуємо вбудований конструктор URL, щоб створити новий об'єкт
  // URL з введеного рядка.
...
// Створюємо функцію з назвою encodeURLComponent, яка приймає один аргумент -
//urlComponent
function encodeURLComponent(urlComponent) {
  // Використовуємо вбудовану функцію encodeURIComponent, щоб закодувати введений
  // компонент URL.
  // Ця функція повертає закодований компонент URL, замінивши небезпечні символи
  // на їх процентне кодування.
  // Повертаємо закодований компонент URL.
  const urlSeven = encodeURIComponent(urlComponent);
  return urlSeven;
}
...
// Створюємо функцію з назвою decodeURLComponent, яка приймає один аргумент -
// urlComponent
function decodeURLComponent(urlComponent) {
  // Використовуємо вбудовану функцію decodeURIComponent, щоб декодувати в
  //ведений закодований компонент URL.
  ...
  const urlNine = decodeURIComponent(urlComponent);
  return urlNine;
}
...
function decodeURL(url) {
  // Використовуємо вбудовану функцію decodeURI, щоб декодувати введений закодований
  //URL.
  // Ця функція повертає декодований URL, замінивши процентне кодування символів
  //на їх реальні значення.
  // Повертаємо декодований URL.
  const urlTen = decodeURI(url);
  return urlTen;
}
